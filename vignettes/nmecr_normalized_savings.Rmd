...
TOWT_baseline_normalized <- calculate_model_predictions(training_data = baseline_df, prediction_data = TMY3_daily, modeled_object = TOWT_baseline_model)
TOWT_performance_normalized <- calculate_model_predictions(training_data = performance_df, prediction_data = TMY3_daily, modeled_object = TOWT_performance_model)
