...
The savings percentage required to meet the threshold of 50% uncertainty, at the 90% confidence level, is 3% (as shown by the output above, see: savings_pct_for_50pct_uncertainty).
