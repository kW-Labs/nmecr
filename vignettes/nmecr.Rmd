...
performance_df <- create_dataframe(eload_data = eload, temp_data = temp, 
                                   start_date = "03/01/2013 00:00", 
                                   end_date = "02/28/2014 23:59", 
                                   convert_to_data_interval = "Daily")
...
Savings achieved at the meter for this project amount to ~8% of the Adjusted Baseline Use with an associated savings uncertainty of 13%. ASHRAE requires that the savings uncertainty for a project be below 50% at the 90% confidence level. The 13% uncertainty is well below this threshold. 
