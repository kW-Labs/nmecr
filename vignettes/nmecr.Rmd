...
The `TOWT_results` object contains all information pertainig to the developed model, some of which is shown below:
...
actual_savings_uncertainty$uncertainty_summary[2, c(2,3)]
