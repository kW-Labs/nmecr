...
3. Savings Uncertainty for 10% savings (at 90% confidence level): 10.1% (shoule be < 50%). 

The savings percentage required to meet the threshold of 50% uncertainty, at the 90% confidence level, is 2% (as shown by the output above, see: savings_pct_for_50pct_uncertainty).
