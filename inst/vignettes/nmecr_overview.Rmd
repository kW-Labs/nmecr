...
baseline_df <- create_dataframe(eload_data = eload, temp_data = temp, 
                                ...
                                convert_to_data_interval = "Daily", timestamps = "start")
...
3. Savings Uncertainty for 10% savings (at 90% confidence level): 16.7% (shoule be < 50%). 
...
Savings achieved at the meter for this project amount to ~7% of the Adjusted Baseline Use with an associated savings uncertainty of 23.9%. ASHRAE requires that the savings uncertainty for a project be below 50% at the 68% confidence level. The 23.9% uncertainty is well below this threshold. 
