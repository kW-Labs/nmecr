...
names(SLR_df) <- c("time", "eload", "temp", "HDD", "CDD", "model_fit_without_op.mode_info")
...
names(SLR_df_with_op_mode) <- c("time", "eload", "temp", "HDD", "CDD", "school holidays", 
...
names(TOWT_df) <- c("time", "eload", "temp", "HDD", "CDD", "model_fit_without_op.mode_info")
...
names(TOWT_df_with_op_mode) <- c("time", "eload", "temp", "HDD", "CDD", "school holidays", 
                                 "summer maintenance", "summer school", "pre-class ramp up",
                                  "model_fit_with_op.mode_info")
...
3. Savings Uncertainty for 10% savings (at 68% confidence level): 20.4% (shoule be < 50%). 
