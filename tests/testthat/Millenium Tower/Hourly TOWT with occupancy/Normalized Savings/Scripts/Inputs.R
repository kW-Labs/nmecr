...
additional_variable_data_file <- "Processed Data/Occupancy.xlsx" # set to NULL if no additional file
TMY_temp_file <- "Processed Data/TMY3.xlsx" 
...
additional_variable_aggregation <- c(mean) # Aggregation functions allowed: sum, mean, median. 
...
expected_normalized_savings <- 1089101

# RUN ANALYSIS ----

setwd(dirname(rstudioapi::getActiveDocumentContext()$path))

rmarkdown::render(input = "Normalized Savings.Rmd", output_format = "word_document", output_dir = "../Results/") # Run for Normalized Savings
